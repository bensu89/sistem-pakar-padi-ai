...
Route::post('/pohaci/analyze', [PohaciAnalysisController::class, 'analyze'])->middleware('throttle:10,1');

Route::get('/pohaci/health', [\App\Http\Controllers\HealthController::class, 'check']);
