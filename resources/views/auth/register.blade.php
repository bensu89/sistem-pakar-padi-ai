...
<head>
    ...
    <title>Daftar — Sistem Pakar Padi AI</title>
...
<body
    ...
    <div class="w-full max-w-md relative z-10 fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-1">Daftar untuk mengakses panel monitoring</p>
        </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    <label for="name" class="block text-sm font-semibold text-gray-700 mb-1.5">
                        <i class="fa-solid fa-user text-green-500 mr-1"></i> Nama Lengkap
                    </label>
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name"
                        autofocus
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/70 focus:bg-white focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition outline-none text-sm @error('name') border-red-400 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password-confirm" type="password" name="password_confirmation" required
                            ...
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/70 focus:bg-white focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition outline-none text-sm pr-12"
                            placeholder="Ketik ulang password">
                        <button type="button" onclick="togglePassword('password-confirm', 'eyeIcon2')"
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-green-600 transition">
