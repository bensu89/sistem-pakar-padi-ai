...
<head>
    ...
    <title>Konfirmasi Password — Sistem Pakar Padi AI</title>
...
<body
    ...
    <div class="w-full max-w-md relative z-10 fade-in">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Konfirmasi Password</h1>
            <p class="text-gray-500 text-sm mt-1">Konfirmasi password Anda sebelum melanjutkan</p>
        </div>
